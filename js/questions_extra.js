...
window.PAA_QUESTIONS_EXTRA = [
  /* ===================== VERBAL ===================== */
  /* -- Bloque Élite 1 (Tutor IA con Markdown) -- */
  { id:"v_elite_01", domain:"verbal", topic:"idea_principal", dif:3, 
    ...
    q:"¿Cuál de las siguientes afirmaciones sintetiza mejor la tesis central del texto?", 
    opts:["La ciencia normal se caracteriza por el cuestionamiento constante de las reglas fundamentales.","El progreso de la ciencia depende exclusivamente de la acumulación lineal de verdades.","El avance científico se produce mediante rupturas radicales de modelos establecidos.","La aparición de anomalías en un modelo indica que la ciencia ha dejado de progresar para siempre."], 
    ans:2, 
    exp:"¡Esta es una clásica trampa de idea principal vs detalle!\n\n¿Qué nos dice el texto desde la primera línea? Nos advierte expresamente que la ciencia **no** es lineal. Inmediatamente nos dice que avanza por **revoluciones** (es decir, rupturas abruptas).\n\nRevisemos los distractores:\n- **Opción B:** Afirma exactamente lo contrario a la tesis del autor.\n- **Opción A:** Confunde lo que ocurre en la 'ciencia normal', donde el texto afirma que *no* se cuestionan las reglas.\n- **Opción D:** Exagera el punto diciendo que la ciencia deja de progresar 'para siempre'.\n\nLa **opción C** captura perfectamente este concepto de 'sustitución abrupta' de los modelos.\n\n**Tip Élite:** En preguntas de idea principal, busca la frase que el autor defiende como su premisa global, no un simple hecho intermedio o una exageración absoluta." 
  },
  { id:"v_elite_02", domain:"verbal", topic:"finalidad", dif:3, 
    stem:"En el siglo XIX, los arquitectos higienistas promovieron la construcción de amplios bulevares en las capitales europeas. Argumentaban que las calles anchas y rectas permitirían la libre circulación de los vientos, disipando las 'miasmas' o vapores nocivos que, según creían, emanaban del suelo y causaban epidemias.\n\nAunque la teoría miasmática fue refutada décadas después por la microbiología moderna de Pasteur, el rediseño urbano perduró, facilitando paradójicamente la instalación de redes de alcantarillado subterráneo, algo que los higienistas originales no habían anticipado como prioridad estructural.", 
    q:"¿Cuál era la finalidad primordial de la construcción de bulevares según los arquitectos del siglo XIX?", 
    opts:["Facilitar la instalación futura de redes modernas de alcantarillado subterráneo.","Erradicar los patógenos microscópicos descubiertos por el biólogo Pasteur.","Permitir la ventilación urbana para dispersar supuestos vapores tóxicos.","Embellecer la ciudad mediante un diseño de calles rectas, anchas y arboladas."], 
    ans:2, 
    exp:"¡Analicemos esto como un detective! El texto tiene una trampa temporal. Nos pregunta por la finalidad de los arquitectos del **siglo XIX**.\n\n¿Qué dice el primer párrafo? Que querían que el viento disipara las 'miasmas' (vapores nocivos). Por tanto, la opción correcta es la **C**.\n\nMuchos estudiantes marcan la **A** porque el texto menciona alcantarillas al final, pero nota que dice *'algo que los higienistas originales no habían anticipado'*. Siempre debes responder desde la perspectiva temporal que pide la pregunta.\n\n**Tip Élite:** Cuando un texto contrasta dos épocas o dos teorías científicas distintas, asegúrate de aislar exactamente qué creía cada bando para no cruzar la información." 
  },
  { id:"v_elite_03", domain:"verbal", topic:"proposiciones", dif:3, 
    stem:"La neuroplasticidad no se limita a las primeras etapas de la infancia. Estudios recientes en pacientes con accidentes cerebrovasculares han demostrado que el cerebro adulto retiene la capacidad de reorganizar sus redes neuronales para compensar funciones perdidas.\n\nAnalice las siguientes proposiciones:\nI. El cerebro adulto es estático y no puede generar nuevas conexiones bajo ninguna circunstancia.\nII. Las lesiones cerebrales en adultos son completamente irreversibles debido a la falta de plasticidad.\nIII. La capacidad de reorganización neuronal se mantiene, al menos parcialmente, durante la etapa adulta.", 
    q:"¿Cuál(es) de las proposiciones se deduce(n) lógicamente del texto anterior?", 
    opts:["Solo la I.","Solo la II.","Solo la III.","La I y la II."], 
    ans:2, 
    exp:"Sé que la lectura científica asusta a veces, pero analicémoslo paso a paso.\n\nEl texto afirma claramente que el cerebro adulto *retiene la capacidad de reorganizar sus redes*.\n\n- **Proposición I:** Dice que el cerebro adulto es 'estático'. Esto **contradice** directamente al texto.\n- **Proposición II:** Dice que las lesiones son 'completamente irreversibles' por falta de plasticidad. De nuevo, el texto afirma que hay plasticidad para *compensar*.\n- **Proposición III:** Afirma que la reorganización neuronal se mantiene en la adultez, lo cual es exactamente la premisa del texto.\n\nPor lo tanto, la única opción válida es **Solo la III (C)**.\n\n**Tip Élite:** Las opciones con palabras absolutistas como 'completamente' o 'bajo ninguna circunstancia' suelen ser falsas en exámenes de razonamiento." 
  },
  { id:"v_elite_04", domain:"verbal", topic:"parafrasis", dif:3, 
    ...
    q:"¿Cuál de las siguientes opciones expresa mejor el mismo concepto utilizando otras palabras?", 
    opts:["La censura institucional es la herramienta más eficaz para eliminar definitivamente ideas peligrosas de la sociedad.","El intento oficial de silenciar un pensamiento rebelde suele provocar que este gane mayor visibilidad y prestigio.","Los pensadores subversivos buscan ser censurados porque es la única forma de conseguir ingresos económicos reales.","Las ideas subversivas nunca logran llegar a una audiencia amplia a menos que las instituciones las aprueben."], 
    ans:1, 
    exp:"¿Has oído hablar del 'Efecto Streisand'? Este texto lo describe a la perfección.\n\nEl texto dice que intentar sofocar (silenciar) una idea subversiva, paradójicamente actúa como una 'caja de resonancia que amplifica su alcance' (le da visibilidad).\n\n- La opción **A** dice lo contrario (que la censura elimina la idea).\n- La opción **C** inventa una motivación económica ('ingresos económicos') que jamás se menciona en el texto.\n- La opción **D** tergiversa todo asumiendo que las ideas necesitan 'aprobación', cuando el texto habla de 'censura'.\n\nLa **opción B** es la paráfrasis exacta de la premisa principal." 
  },
  { id:"v_elite_05", domain:"verbal", topic:"comportamiento", dif:3, 
    stem:"Frente a la crisis económica de la década, la gerencia optó por una estrategia inusual: en lugar de reducir la plantilla como dictaban los manuales tradicionales, recortó los salarios directivos en un 40% e instauró una jornada de cuatro días.\n\nEsta medida, aunque inicialmente impopular entre los accionistas que temían una caída en productividad, generó un sentido de lealtad sin precedentes en la base laboral, lo que redujo la fuga de talentos a casi cero.", 
    q:"¿Cómo se puede caracterizar el comportamiento de la gerencia frente a la crisis?", 
    opts:["Ortodoxo, al seguir estrictamente los manuales corporativos de su sector.","Deplorable, al priorizar los intereses de los directivos sobre los accionistas.","Imprudente, al ignorar de forma deliberada la inminente fuga de talentos.","Heterodoxo, priorizando la retención del talento humano mediante sacrificios cúpula."], 
    ans:3, 
    exp:"Vamos a desarmar las opciones falsas. \n\n- ¿Fue **ortodoxo** (es decir, seguir las reglas tradicionales)? No, el texto dice expresamente 'en lugar de... como dictaban los manuales'. Así descartamos la A.\n- ¿Fue **imprudente** respecto a la fuga de talentos? Al contrario, la redujo a cero, así que la C es falsa.\n- ¿Priorizó a los **directivos**? No, les recortó el salario un 40%.\n\nLa única que calza lógicamente es la **D**: fue un movimiento heterodoxo (fuera de la norma) que priorizó la retención del talento.\n\n**Tip Élite:** El examen PAA asume que dominas vocabulario académico medio. Conocer la diferencia entre *ortodoxo* y *heterodoxo* te ahorrará mucho tiempo de lectura." 
  },
  /* ===================== MATEMÁTICO ===================== */
  { id:"m_elite_01", domain:"math", topic:"algebra_notacion", dif:3, 
    stem:"Un granjero decide comprar cerdos y gallinas. Por cada cerdo que compra, adquiere exactamente tres gallinas. Si sabemos que la cantidad total de animales comprados, denotada por 'T', es un número **par positivo estrictamente menor a 20**.", 
    q:"¿Cuál es la cantidad MÁXIMA de cerdos que el granjero pudo haber comprado?", 
    opts:["4","5","3","6"], 
    ans:0, 
    exp:"Sé que es tentador probar números al azar usando las respuestas, pero analicémoslo matemáticamente para no caer en la trampa.\n\n1. Si 'c' son los cerdos y 'g' las gallinas, el problema impone que: **g = 3c**.\n2. El total de animales es T = c + g.\n3. Sustituyendo, tenemos: T = c + 3c = **4c**.\n\nEsto significa que el total T debe ser un **múltiplo de 4** (4, 8, 12, 16, 20...).\n\nEl problema dice explícitamente que T es estrictamente menor a 20. Por lo tanto, el T máximo posible es **16**.\n\nSi T = 16, y sabemos que T = 4c:\n16 = 4c  \n**c = 4 cerdos** (Opción A).\n\n**El Anzuelo:** Muchos eligen 5 porque 5x4=20, ¡pero la restricción dice *menor* a 20, no menor o igual!" 
  },
  { id:"m_elite_02", domain:"math", topic:"aritmetica", dif:3, 
    stem:"En una tienda, un confite cuesta ₡75 y un chocolate cuesta ₡120. Andrés desea comprar 8 confites y una cantidad 'x' de chocolates, donde 'x' es un número entero positivo.\n\nSi Andrés paga con un billete de ₡2 000 y el dependiente le devuelve exactamente ₡680 de vuelto.", 
    q:"¿Cuántos chocolates compró Andrés?", 
    opts:["3","6","8","960"], 
    ans:1, 
    exp:"¡Cuidado aquí! Detengámonos un momento a hacer ingeniería inversa.\n\nSi pagó con ₡2 000 y le devolvieron ₡680, ¿cuánto gastó en total el señor Andrés?\n**Gasto Total:** 2000 - 680 = **1320**.\n\nAhora, sabemos que compró 8 confites a ₡75 cada uno:\n**Gasto en confites:** 8 × 75 = **600**.\n\n¿Cuánto dinero de ese gasto total corresponde a los chocolates?\n**Gasto en chocolates:** 1320 - 600 = **720**.\n\nSi cada chocolate vale 120, entonces:\n720 ÷ 120 = **6 chocolates**.\n\n**Tip Élite:** La opción '960' es un distractor diseñado para cazar a quienes olvidan restar el vuelto del billete inicial. ¡Lee despacio y triunfarás!" 
  },
  { id:"m_elite_03", domain:"math", topic:"relaciones_orden", dif:3, 
    stem:"Considere tres variables numéricas desconocidas: P, Q y R. Se sabe con absoluta certeza que:\n- P es mayor que Q.\n- Q es un número estrictamente negativo.\n- El valor absoluto de Q es mayor que el valor absoluto de P.", 
    q:"¿Cuál de las siguientes afirmaciones es SIEMPRE verdadera?", 
    opts:["P + Q > 0","P + Q < 0","P es un número negativo","P = 0"], 
    ans:1, 
    exp:"¿Te confunde ver tantas letras sin números? ¡Esa es exactamente la intención del examen! Hagámoslo fácil asignando valores hipotéticos que cumplan las reglas:\n\n1. Q es negativo. Digamos que **Q = -10**.\n2. P es mayor que Q. Podría ser P = 5 o P = -2.\n3. PERO el valor absoluto de Q (10) debe ser mayor que el valor absoluto de P.\n\nEsto significa que P es un número 'más pequeño en tamaño' (ej. 5 o -2). \n\n¿Qué pasa si sumamos P + Q?\nYa sea (5 + -10 = -5) o (-2 + -10 = -12), el resultado **siempre será negativo** porque el peso del negativo (Q) es abrumadoramente mayor que cualquier valor que pueda tomar P.\n\nPor tanto, **P + Q < 0** es la única verdad absoluta." 
  },
  { id:"m_elite_04", domain:"math", topic:"geometria", dif:3, 
    fig: "<svg viewBox='0 0 200 100' style='background:#121B24; border: 1px solid #25333F; max-width:100%; border-radius: 8px;'><rect x='10' y='10' width='180' height='80' fill='none' stroke='#C792EA' stroke-width='2'/><rect x='10' y='10' width='80' height='80' fill='#2EE6A6' opacity='0.2' stroke='#2EE6A6' stroke-width='2'/><text x='100' y='55' fill='#EAF2F4' font-family='sans-serif' font-size='12' text-anchor='middle'>Sobrante = 50 m²</text></svg>",
    stem:"Considere el terreno rectangular de la figura, cuyo largo mide exactamente el doble que su ancho. El propietario decide construir una piscina cuadrada (zona sombreada verde) cuyo lado es igual al ancho del terreno original. Se indica que el área del terreno sobrante (zona vacía) es de 50 metros cuadrados.", 
    q:"¿Cuál es el perímetro total del terreno rectangular original?", 
    opts:["30 metros","42.4 metros (aprox.)","50 metros","60 metros"], 
    ans:1, 
    exp:"¡Visualicémoslo juntos usando la figura!\n\nSi el largo es el doble del ancho (L = 2A), significa que el terreno total está compuesto literalmente por **dos cuadrados perfectos** pegados uno junto al otro.\n\nSi la piscina cuadrada (área verde) ocupa uno de esos cuadrados, el 'sobrante' (zona vacía) es idéntico: es el otro cuadrado.\n\nEl problema dice que el sobrante mide 50 m². Por ende, el área de un cuadrado es A² = 50.\nSi A² = 50, entonces el ancho es **A = √50** (aproximadamente 7.07).\n\nNos piden el **perímetro del rectángulo original**:\nFórmula: 2L + 2A.\nSustituyendo: 2(2A) + 2A = 4A + 2A = **6A**.\n\nMultiplicamos: 6 × 7.07 ≈ **42.4 metros**.\n\n**Tip Élite:** No entres en pánico si no tienes calculadora y ves una raíz. El examen a menudo te dará aproximaciones o raíces inexactas para medir tu capacidad de deducir, no tu capacidad de usar la calculadora." 
  },
  { id:"m_elite_05", domain:"math", topic:"conteo", dif:3, 
    stem:"Un dispositivo de seguridad requiere una contraseña de 3 dígitos (del 0 al 9). El manual especifica dos restricciones fundamentales:\n1) El primer dígito NO puede ser 0.\n2) Todos los dígitos deben ser distintos entre sí.", 
    q:"¿Cuántas contraseñas diferentes es posible configurar en este dispositivo?", 
    opts:["648","729","1000","504"], 
    ans:0, 
    exp:"Este es un clásico problema del **Principio Multiplicativo** con restricciones. Vamos a llenar 3 'casillas' mentales: [ _ ] [ _ ] [ _ ]\n\n1. **Primera casilla:** Tiene los dígitos del 0 al 9 (10 opciones). PERO la regla dice que no puede ser 0. Así que tenemos **9 opciones válidas** (del 1 al 9).\n\n2. **Segunda casilla:** De nuevo, los dígitos del 0 al 9 (10 opciones). Esta vez *sí* podemos usar el 0, PERO la regla dice que no podemos repetir el dígito que usamos en la primera casilla. Así que tenemos 10 - 1 = **9 opciones válidas**.\n\n3. **Tercera casilla:** Teníamos 10 dígitos, pero ya quemamos dos distintos en las casillas anteriores. Así que nos quedan 10 - 2 = **8 opciones válidas**.\n\nMultiplicamos las posibilidades: 9 × 9 × 8 = **648**.\n\n**Tip Élite:** Siempre resuelve las restricciones más estrictas primero (como el 'primer dígito no puede ser 0'). Si ignoras esto y asumes 10x9x8, marcarías erróneamente la opción 720 (que ni siquiera está para salvarte) o la 729." 
  },
  ...
  { id:"v_fin_6", domain:"verbal", topic:"finalidad", dif:3,
    ...
    ans:1, exp:"El propósito es incentivar la compra de eléctricos y bajar la contaminación: promover vehículos menos contaminantes (B). No busca recaudar (A): de hecho baja impuestos; tampoco encarecer la gasolina (C) ni hacer carreteras (D)." },
  { id:"v_fin_7", domain:"verbal", topic:"finalidad", dif:2, stem:"Pedro programa tres alarmas con cinco minutos de diferencia cada mañana. Dice que no lo hace porque le guste el ruido, sino porque sabe que con una sola se volvería a dormir y llegaría tarde.", q:"¿Cuál es la finalidad de poner varias alarmas?", opts:["Disfrutar el sonido de las alarmas","Asegurarse de despertar y no llegar tarde","Despertar a toda la casa","Cumplir una costumbre sin sentido"], ans:1, exp:"El para qué es despertar y no llegar tarde (B). El texto descarta que sea por el sonido (A); no busca despertar a la casa (C) ni es una costumbre sin sentido (D), pues explica su razón." },
  ...
  { id:"v_cau_6", domain:"verbal", topic:"causa_consecuencia", dif:2,
    ...
    ans:1, exp:"El aumento del combustible provocó que los productos se encarecieran (B). Bajar de precio (A) y subir los salarios (D) son lo contrario; que el combustible se agote (C) no se dice." },
  { id:"v_cau_7", domain:"verbal", topic:"causa_consecuencia", dif:2,
    ...
    ans:1, exp:"'Gracias a que estudió con constancia' señala la causa: el estudio constante (B). No fue la suerte (A) ni la facilidad del examen (C); la ayuda de amigos (D) no se menciona." },
  { id:"v_cau_8", domain:"verbal", topic:"causa_consecuencia", dif:3,
    ...
    ans:1, exp:"La cadena es: la tala dejó el suelo sin raíces y por eso hubo deslizamientos; la causa de fondo es la tala (B). La lluvia sola (A) no bastaría sin esa debilidad; construir casas (C) y la falta de lluvia (D) no aparecen." },
  { id:"v_cau_9", domain:"verbal", topic:"causa_consecuencia", dif:2,
    ...
    ans:0, exp:"Usar el agua de forma responsable (causa) asegura reservas para la sequía (consecuencia) (A). B y C contradicen el texto; y la sequía sí afecta, así que D es falso." },
  ...
  { id:"v_sim_4", domain:"verbal", topic:"simple_complejo", dif:2,
    ...
    ans:1, exp:"La diferencia es la cantidad de elementos y procesos: la vela necesita un fósforo; la central, turbinas, controles e ingenieros (B). No se comparan por antigüedad (A), color (C) ni precio (D)." },
  ...
  { id:"v_sim_7", domain:"verbal", topic:"simple_complejo", dif:3,
    ...
    ans:1, exp:"El banquete reúne muchas tareas interrelacionadas: más complejo que freír un huevo (B). No es igual de simple (A); su valor nutritivo (C) y la rapidez (D) no se comparan." },
  ...
  { id:"v_con_5", domain:"verbal", topic:"conceptualizacion", dif:2,
    ...
    ans:0, exp:"Devolver lo ajeno aun sin ser visto es honradez (A). No es astucia (B: no busca ventaja), ni timidez (C) ni indiferencia (D), que no explican el gesto." },
  { id:"v_con_6", domain:"verbal", topic:"conceptualizacion", dif:2,
    ...
    ans:1, exp:"Esforzarse sin quejarse para cumplir lo acordado refleja compromiso (B). Es lo contrario de pereza (A); y no es vanidad (C) ni suerte (D), pues depende de su esfuerzo." },
  { id:"v_con_7", domain:"verbal", topic:"conceptualizacion", dif:2,
    ...
    ans:0, exp:"Ponerse en el lugar del otro para comprender lo que siente es empatía (A). No es envidia (B) ni orgullo (D); y va más allá de la simple curiosidad (C)." },
  ...
  { id:"v_con_9", domain:"verbal", topic:"conceptualizacion", dif:3,
    ...
    ans:0, exp:"Insistir con calma pese a fallar diez veces es tenacidad (A). Es lo opuesto a pereza (B) y distracción (D); y no es suerte (C), pues depende de su constancia." },
  ...
  { id:"v_ord_4", domain:"verbal", topic:"orden_desorden", dif:2,
    ...
    ans:1, exp:"Pasó de herramientas tiradas (desorden) a cada una en su gancho rotulado (orden): del desorden al orden (B). A es lo contrario; nuevo/viejo (C) y tamaño (D) no son el cambio." },
  { id:"v_ord_5", domain:"verbal", topic:"orden_desorden", dif:2, stem:"En la biblioteca, cada libro tiene un código, está ubicado por materia y por autor, y siempre se devuelve al mismo estante; así cualquiera encuentra lo que busca en segundos.", q:"¿Cómo puede describirse esa biblioteca?", opts:["Desordenada","Ordenada","Improvisada","Abandonada"], ans:1, exp:"Códigos, ubicación por materia y autor, y todo en su sitio describen una biblioteca ordenada (B). No es desordenada (A), ni improvisada (C) o abandonada (D): justo lo opuesto." },
  ...
  { id:"v_ord_7", domain:"verbal", topic:"orden_desorden", dif:3,
    ...
    ans:1, exp:"Pasar de documentos sueltos a categorías claras es organizar lo que estaba en desorden (B). No aumenta el desorden (A), no se pierden archivos (C) ni se trata de colores (D)." },
  ...
  { id:"v_tmp_5", domain:"verbal", topic:"orden_temporal", dif:2, stem:"Para publicar el video, Sofía primero lo graba, luego lo edita cortando los errores, después le agrega subtítulos y, finalmente, lo sube a la plataforma.", q:"¿Qué hace Sofía justo después de editar el video?", opts:["Grabarlo","Agregarle subtítulos","Subirlo a la plataforma","Borrarlo"], ans:1, exp:"El orden es grabar, editar, subtítulos y subir. Después de editar agrega los subtítulos (B). Grabar (A) fue antes; subir (C) es el final; borrarlo (D) no aparece." },
  ...
  { id:"v_tmp_7", domain:"verbal", topic:"orden_temporal", dif:3,
    ...
    ans:1, exp:"La secuencia es cortinas, primer acto, intermedio y segundo acto. Antes del segundo acto está el intermedio (B). El primer acto (A) y la apertura (C) van antes; los aplausos (D), al final." },
  ...
  { id:"v_ese_4", domain:"verbal", topic:"esencia", dif:3,
    ...
    ans:0, exp:"Por lógica paralela con el médico (escuchar, examinar, dar lo apropiado), lo propio del mecánico es escuchar, revisar y reparar lo necesario (A). Cobrar de más (B), cambiar todo siempre (C) o no revisar (D) son lo contrario de un buen mecánico." },
  ...
  { id:"v_ese_6", domain:"verbal", topic:"esencia", dif:2, stem:"Así como lo propio de un reloj es marcar el paso del tiempo —no su forma ni su material—, cada instrumento se define por la función que cumple.", q:"Por esa misma lógica, ¿qué es lo propio de un termómetro?", opts:["Marcar la hora","Medir la temperatura","Indicar la dirección","Pesar objetos"], ans:1, exp:"Lo propio es la FUNCIÓN. La del termómetro es medir la temperatura (B). Marcar la hora (A) es del reloj; indicar dirección (C), de la brújula; pesar (D), de la balanza." },
  ...
  /* -- Perspectiva -- */
  { id:"v_per_4", domain:"verbal", topic:"perspectiva", dif:2, stem:"El invierno que arruina las vacaciones del turista es justo la temporada que llena de clientes la tienda de abrigos.", q:"¿Qué muestra este contraste?", opts:["Que el invierno perjudica a todos","Que un mismo hecho beneficia a unos y perjudica a otros","Que el turista se queja de más","Que las tiendas se aprovechan de la gente"], ans:1, exp:"El mismo invierno tiene efectos opuestos: malo para el turista, bueno para el negocio (B). A generaliza un solo lado; C y D agregan juicios que el texto no plantea." },
  { id:"v_per_5", domain:"verbal", topic:"perspectiva", dif:2, stem:"Subir la misma montaña es, para el niño lleno de energía, una emocionante aventura; para el anciano de rodillas cansadas, un esfuerzo agotador.", q:"¿Qué explica que la montaña se viva de forma tan distinta?", opts:["La montaña cambia de altura según quién sube","La experiencia depende de la condición y la mirada de cada quien","El niño exagera su emoción","El anciano no debería caminar"], ans:1, exp:"La montaña no cambia (A es falso); lo que cambia es quién la sube y cómo la vive (B). C y D juzgan a una persona, pero el punto es que un mismo hecho se vive distinto." },
  { id:"v_per_6", domain:"verbal", topic:"perspectiva", dif:3, stem:"Reprobar un examen puede vivirse como un golpe definitivo o como una señal útil de qué temas conviene reforzar.", q:"¿Qué plantea el texto sobre un mismo hecho?", opts:["Que reprobar no tiene remedio","Que admite lecturas opuestas según cómo se interprete","Que los exámenes son injustos","Que da igual aprobar o reprobar"], ans:1, exp:"El mismo hecho (reprobar) admite dos lecturas: fracaso u oportunidad de mejorar (B). A se queda solo con la lectura negativa; C culpa al examen; D banaliza, y el texto no dice eso." },
  { id:"v_per_7", domain:"verbal", topic:"perspectiva", dif:2, stem:"La canción que una persona pone a buen volumen para animarse es, para la vecina que intenta dormir, un ruido insoportable.", q:"¿Qué idea expresa el texto?", opts:["La música siempre molesta a los demás","Un mismo sonido se vive distinto según la situación de cada quien","Está prohibido escuchar música","La vecina tiene mal gusto"], ans:1, exp:"El mismo sonido es disfrute para uno y molestia para otra, según su situación (B). A generaliza; C inventa una prohibición; D descalifica sin que el texto lo diga." },
  { id:"v_per_8", domain:"verbal", topic:"perspectiva", dif:2, stem:"Un mismo comentario directo, a unas personas les parece una muestra de sinceridad y a otras, una grosería.", q:"Según el texto, ¿de qué depende que el comentario se tome bien o mal?", opts:["De que el comentario sea verdadero","De cómo lo interpreta quien lo recibe","De que se diga en voz alta","De que la persona sea grosera"], ans:1, exp:"El mismo comentario cambia de sentido según quién lo recibe e interpreta (B). A, C y D señalan rasgos del comentario en sí, pero el texto pone el peso en la interpretación del receptor." },
  ...
  { id:"v_imp_6", domain:"verbal", topic:"idea_implicita", dif:2,
    ...
    ans:1, exp:"Que le duela el estómago cada vez que come ahí implica que algo de esa comida le hace daño (B). A contradice que sí va a comer; el precio (C) y 'nunca come' (D) no vienen al caso." },
  { id:"v_imp_7", domain:"verbal", topic:"idea_implicita", dif:2,
    ...
    ans:1, exp:"Que se llene en época de exámenes implica que entonces la gente estudia más (B). El tamaño (A), 'nadie la usa' (C) y 'libros gratis' (D) no se deducen." },
  { id:"v_imp_8", domain:"verbal", topic:"idea_implicita", dif:2,
    ...
    ans:1, exp:"Llevar paraguas, botas y abrigo implica que esperaba mal tiempo (B). Una fiesta (A), vender ropa (C) o mucho calor (D) no encajan con ese equipo." },
  { id:"v_imp_9", domain:"verbal", topic:"idea_implicita", dif:3, stem:"Llegué a la casa y todo estaba como lo había dejado: el periódico del lunes seguía en la entrada, el tazón del desayuno sin lavar y las luces apagadas en pleno día.", q:"¿Qué se puede deducir con seguridad?", opts:["Hubo una fiesta la noche anterior","Nadie había estado en la casa desde el lunes","Acababan de limpiar la casa","Había mucha gente adentro"], ans:1, exp:"Periódico del lunes intacto, tazón sin lavar y luces apagadas implican que nadie estuvo ahí desde el lunes (B). Una fiesta (A) o mucha gente (C) dejarían rastros; 'recién limpiado' (D) contradice el desorden." },
  { id:"v_imp_10", domain:"verbal", topic:"idea_implicita", dif:2,
    ...
    ans:1, exp:"Revisar tres veces la puerta implica que es precavida con la seguridad (B). Es lo opuesto a descuidada (A); 'no duerme' (C) y 'puerta rota' (D) no se deducen." },
  { id:"v_imp_11", domain:"verbal", topic:"idea_implicita", dif:3,
    ...
    ans:1, exp:"Rechazar más sueldo por quedarse implica que valora algo más que el salario (B). A dice lo contrario; 'no sabe decidir' (C) y 'la empresa cerró' (D) no aparecen." },

  /* -- Idea principal / tema -- */
  { id:"v_pri_4", domain:"verbal", topic:"idea_principal", dif:2, stem:"El reciclaje reduce la cantidad de basura que llega a los rellenos, ahorra recursos naturales al reutilizar materiales y disminuye la contaminación del aire y del agua.", q:"¿Cuál es la idea principal del texto?", opts:["En los rellenos se acumula mucha basura","El reciclaje aporta varios beneficios ambientales","El reciclaje reutiliza materiales","Reciclar limpia el aire"], ans:1, exp:"A, C y D son detalles ciertos, pero cada uno cubre solo una parte. La idea que los abarca a todos es que el reciclaje trae varios beneficios (B): esa es la principal." },
  { id:"v_pri_5", domain:"verbal", topic:"idea_principal", dif:2, stem:"Las abejas polinizan los cultivos de los que sale buena parte de nuestra comida, producen miel y ayudan a mantener el equilibrio de muchos ecosistemas.", q:"¿Cuál es la idea principal del texto?", opts:["Las abejas producen miel","Las abejas cumplen un papel valioso para la naturaleza y las personas","Las abejas polinizan cultivos","Las abejas viven en ecosistemas"], ans:1, exp:"Producir miel y polinizar (A, C) son detalles, no el todo. B resume todos los aportes de las abejas. D es cierto pero trivial y no es el punto central." },
  { id:"v_pri_6", domain:"verbal", topic:"idea_principal", dif:2, stem:"Leer con frecuencia amplía el vocabulario, ejercita la memoria y expone la mente a ideas y puntos de vista nuevos.", q:"¿Cuál es la idea principal?", opts:["Leer amplía el vocabulario","La lectura aporta varios beneficios para la mente","Leer ejercita la memoria","Existen muchas ideas nuevas"], ans:1, exp:"A y C son beneficios sueltos (detalles); D se va del tema. B reúne todos esos beneficios: es la idea principal." },
  { id:"v_pri_7", domain:"verbal", topic:"idea_principal", dif:3,
    ...
    ans:1, exp:"Todo el texto sigue el recorrido del río y su aporte a la vida (B). El color del agua (A), la altura de la montaña (C) y la pesca (D) son detalles o ni aparecen." },
  { id:"v_pri_8", domain:"verbal", topic:"idea_principal", dif:2, stem:"Dormir bien mejora la memoria, fortalece las defensas del cuerpo y ayuda a mantener estable el estado de ánimo.", q:"¿Cuál es la idea principal?", opts:["Dormir mejora la memoria","Un buen descanso beneficia el cuerpo y la mente","Dormir fortalece las defensas","El ánimo cambia de a ratos"], ans:1, exp:"A y C son beneficios concretos (detalles). B los engloba: dormir bien beneficia cuerpo y mente. D es vago y no resume el texto." },
  { id:"v_pri_9", domain:"verbal", topic:"idea_principal", dif:3,
    ...
    ans:0, exp:"Las tres lenguas son una muestra de la diversidad lingüística de Costa Rica (A). La gramática (B), la población de Limón (C) y la enseñanza del inglés (D) son temas que el texto no desarrolla." },

  /* -- Paráfrasis -- */
  { id:"v_par_4", domain:"verbal", topic:"parafrasis", dif:3, stem:"El conocimiento que no se comparte termina por desvanecerse, como el agua estancada se pudre.", q:"¿Cuál opción expresa la misma idea?", opts:["El conocimiento es inútil","El saber se mantiene vivo cuando se comparte","El agua estancada es saludable","Compartir es una pérdida de tiempo"], ans:1, exp:"Que el conocimiento no compartido se desvanezca equivale a que el saber se mantiene vivo al compartirse (B). A lo desvaloriza; C malinterpreta la comparación del agua; D contradice la idea de compartir." },
  ...
  { id:"v_par_6", domain:"verbal", topic:"parafrasis", dif:3, stem:"El hecho de que algo sea muy popular no garantiza que sea bueno.", q:"¿Cuál opción dice lo mismo con otras palabras?", opts:["Lo popular siempre es bueno","La popularidad no asegura la calidad","Nada bueno llega a ser popular","Hay que seguir siempre a la mayoría"], ans:1, exp:"Que lo popular no garantice calidad equivale a que la popularidad no asegura que algo sea bueno (B). A dice lo contrario; C exagera al negar toda relación; D invita a seguir a la mayoría, lo opuesto al texto." },
  { id:"v_par_7", domain:"verbal", topic:"parafrasis", dif:3,
    ...
    ans:1, exp:"Que la libertad de uno termine donde empieza la del otro equivale a que la libertad propia tiene como límite la de los demás (B). A niega la libertad; C dice que no tiene límites; D la reserva a una sola persona." },
  { id:"v_par_8", domain:"verbal", topic:"parafrasis", dif:3, stem:"Quien ignora los pequeños problemas de hoy suele enfrentarse a grandes problemas mañana.", q:"¿Cuál opción reproduce la idea?", opts:["Los problemas pequeños no importan","Descuidar lo pequeño hoy trae problemas mayores después","Mañana no existirán los problemas","Lo mejor es ignorar todo"], ans:1, exp:"Que ignorar lo pequeño hoy traiga grandes problemas mañana equivale a 'descuidar lo pequeño hoy trae problemas mayores después' (B). A le quita importancia; C y D distorsionan el sentido." },
  ...
  { id:"v_pro_4", domain:"verbal", topic:"proposiciones", dif:3,
    ...
    ans:0, exp:"De 'todos los metales conducen' se deduce que el cobre, que es metal, conduce: la I (A). La II y la III afirman metales que no conducen, lo que contradice el texto." },
  { id:"v_pro_5", domain:"verbal", topic:"proposiciones", dif:3,
    ...
    ans:1, exp:"De 'todo inscrito debe presentar cédula' se deducen la I y la III (sin cédula no se cumple): por eso B. La II dice que es opcional, lo contrario del texto." },
  { id:"v_pro_6", domain:"verbal", topic:"proposiciones", dif:2,
    ...
    ans:0, exp:"De 'cuando llueve, la cancha se moja' se deduce que la lluvia la moja: la I (A). La II (se moja sola) y la III (la lluvia la seca) no se deducen." },
  { id:"v_pro_7", domain:"verbal", topic:"proposiciones", dif:3,
    ...
    ans:1, exp:"De 'ninguno aprobó sin entregar' se deducen la I (entregar fue necesario) y la III (quien no entregó no aprobó): por eso B. La II contradice el texto." },
  { id:"v_pro_8", domain:"verbal", topic:"proposiciones", dif:2,
    ...
    q:"¿Cuál proposición se deduce del texto?",
    opts:["Solo la I","Solo la II","La II y la III","Las tres"],
    ans:0, exp:"De 'todas las aves tienen plumas' se deduce que el gorrión, que es ave, tiene plumas: la I (A). La II y la III afirman aves sin plumas, contra el texto." },
  ...
  { id:"v_cau_12", domain:"verbal", topic:"causa_consecuencia", dif:3,
    ...
    ans:1, exp:"Usar protector (causa) reduce el riesgo de quemaduras (consecuencia) (B). A invierte la relación; el sol sí daña, así que C es falso; y las quemaduras no son inevitables (D): justo se pueden prevenir." },

  /* -- Verbal: simple y complejo -- */
  { id:"v_sim_8", domain:"verbal", topic:"simple_complejo", dif:2, stem:"Armar un sándwich lleva dos o tres pasos; preparar un pastel de bodas implica seguir recetas, controlar tiempos de horneado y cuidar una decoración detallada.", q:"¿Qué diferencia esencial muestra el texto entre ambas preparaciones?", opts:["Que una es más cara que la otra","Que una implica muchos más pasos y partes que la otra","Que una es más sabrosa que la otra","Que una es más antigua que la otra"], ans:1, exp:"El contraste no es de precio (A), sabor (C) ni antigüedad (D), sino de cantidad de pasos y partes: el pastel es mucho más complejo que el sándwich (B)." },
  { id:"v_sim_9", domain:"verbal", topic:"simple_complejo", dif:2, stem:"Hervir agua es una tarea de un solo paso. Cocinar un menú de tres tiempos para veinte invitados exige planear las compras, calcular los tiempos de cada plato y coordinar varias preparaciones a la vez.", q:"¿Cómo es cocinar ese menú frente a hervir agua?", opts:["Más simple","Más complejo","Más rápido","Más barato"], ans:1, exp:"El menú de tres tiempos exige planear, calcular y coordinar varias preparaciones: más complejo que hervir agua (B). No es más simple (A), ni se compara por rapidez (C) o precio (D)." },
  ...
  { id:"v_con_10", domain:"verbal", topic:"conceptualizacion", dif:2,
    ...
    ans:0, exp:"Compartir su almuerzo sin que se lo pidan es solidaridad (A). Es lo contrario de envidia (B), pereza (C) y orgullo (D)." },
  ...
  { id:"v_tmp_8", domain:"verbal", topic:"orden_temporal", dif:2,
    ...
    ans:1, exp:"La secuencia es hervir, agregar el café, colar y servir. Antes de servir se cuela (B). Hervir (A) y agregar el café (C) van antes; lavar la taza (D) no es parte del proceso." },
  { id:"v_tmp_9", domain:"verbal", topic:"orden_temporal", dif:2,
    ...
    ans:1, exp:"La secuencia es calentar, correr y estirar. Después de correr, estira (B). Calentar (A) es antes de correr; inscribirse (C) y dormir (D) no aparecen en el texto." },

  /* -- Verbal: esencia -- */
  { id:"v_ese_8", domain:"verbal", topic:"esencia", dif:2, stem:"Igual que lo esencial de una brújula es señalar siempre el norte —sin importar su tamaño—, cada herramienta se reconoce por aquello que hace.", q:"Por la misma lógica, ¿qué es lo propio de un termómetro?", opts:["Señalar el norte","Medir la temperatura","Marcar la hora","Medir distancias"], ans:1, exp:"Lo esencial es la función. La del termómetro es medir la temperatura (B). Señalar el norte (A) es de la brújula; marcar la hora (C), del reloj; medir distancias (D), de la regla." },
  ...
  /* -- Verbal: perspectiva -- */
  { id:"v_per_9", domain:"verbal", topic:"perspectiva", dif:3, stem:"El mismo silencio de la casa vacía relaja a quien busca paz y angustia a quien teme quedarse solo.", q:"¿Qué muestra el texto?", opts:["El silencio es siempre incómodo","Un mismo hecho se vive distinto según lo que cada quien siente","Nadie soporta el silencio","El silencio no afecta a las personas"], ans:1, exp:"El mismo silencio calma a uno y angustia a otro según su estado interior (B). A y C generalizan un solo lado; D niega justo lo que el texto describe." },
  { id:"v_per_10", domain:"verbal", topic:"perspectiva", dif:2, stem:"La primera nevada es, para el turista, un espectáculo encantador; para el habitante que debe palear la entrada cada mañana, una molestia más.", q:"¿Qué explica la diferencia de reacciones?", opts:["La nieve es más bonita en unos lugares","Cada quien la valora según cómo afecta su vida diaria","El turista no conoce la nieve de verdad","El habitante odia el invierno"], ans:1, exp:"La misma nieve es novedad para el turista y carga diaria para el habitante (B). A cambia el tema; C y D juzgan a una persona, pero el punto es cómo afecta a cada quien." },
  ...
  { id:"v_imp_12", domain:"verbal", topic:"idea_implicita", dif:2,
    ...
    ans:1, exp:"Que las hojas se pongan amarillas con esa agua implica que algo en el agua les hace daño (B). 'No necesitan agua' (A) y 'están sanas' (D) se descartan; el sol (C) no se menciona." },
  { id:"v_imp_13", domain:"verbal", topic:"idea_implicita", dif:3, stem:"El restaurante abrió hace apenas un mes, pero ya hay que reservar con una semana de anticipación y la fila para entrar sin reserva da vuelta a la esquina.", q:"¿Qué se puede deducir del texto?", opts:["El restaurante va a cerrar pronto","El restaurante se volvió muy popular","La comida es de mala calidad","Nadie quiere ir a ese lugar"], ans:1, exp:"Reservar con una semana y la fila a la vuelta implican que el restaurante se volvió muy popular (B). Cerrar (A), mala comida (C) o que nadie quiera ir (D) contradicen esa demanda." },
  { id:"v_imp_14", domain:"verbal", topic:"idea_implicita", dif:3, stem:"Aunque nunca menciona sus logros, su oficina está repleta de diplomas y reconocimientos acumulados durante veinte años de trabajo.", q:"¿Qué se puede deducir del texto?", opts:["No ha logrado nada importante","Tiene una trayectoria destacada, aunque no la presuma","Compró los diplomas","Acaba de empezar a trabajar"], ans:1, exp:"Una oficina llena de diplomas de 20 años, sin presumirlos, implica una trayectoria destacada aunque no la muestre (B). A la niega; 'compró los diplomas' (C) y 'recién empezó' (D) no se deducen." },

  /* -- Verbal: idea principal -- */
  { id:"v_pri_10", domain:"verbal", topic:"idea_principal", dif:2, stem:"El agua potable es un recurso escaso: hay que tratarla para hacerla segura, distribuirla con cuidado y evitar desperdiciarla.", q:"¿Cuál es la idea principal?", opts:["El agua potable se debe tratar","El agua potable es escasa y exige cuidarla en todo su manejo","El agua se distribuye por tuberías","No hay que desperdiciar el agua"], ans:1, exp:"A y D son acciones puntuales (detalles); C no aparece así en el texto. B recoge la idea de fondo: por ser escasa, hay que cuidarla en todo el proceso." },
  { id:"v_pri_11", domain:"verbal", topic:"idea_principal", dif:2, stem:"El ejercicio regular, una alimentación balanceada y un buen descanso forman, juntos, la base de una vida sana.", q:"¿Cuál es la idea principal?", opts:["El ejercicio es lo más importante","Varios hábitos combinados sostienen una vida sana","Hay que dormir bien","La comida debe ser balanceada"], ans:1, exp:"C y D toman un solo hábito cada uno (detalles); A exagera al poner uno por encima. El texto dice que JUNTOS forman la base: por eso B." },
  { id:"v_pri_12", domain:"verbal", topic:"idea_principal", dif:2, stem:"El volcán Arenal atrae turistas de todo el mundo, genera empleo en los pueblos cercanos y se ha vuelto un símbolo natural de Costa Rica.", q:"¿Cuál es el tema central?", opts:["El Arenal atrae turistas","El valor turístico, económico y simbólico del volcán Arenal","El Arenal da empleo a la zona","El Arenal es un volcán muy alto"], ans:1, exp:"A y C son aportes sueltos (detalles); D es un dato que ni aparece. B une las tres ideas (turismo, empleo, símbolo): ese es el tema central." },

  /* -- Verbal: paráfrasis -- */
  { id:"v_par_9", domain:"verbal", topic:"parafrasis", dif:3, stem:"Responder a cada provocación solo le da más fuerza; a veces el mejor gesto es el silencio.", q:"¿Cuál opción expresa la misma idea?", opts:["Hay que responder a toda provocación","A veces callar ante la provocación es lo más sabio","El silencio siempre es cobardía","Provocar a los demás es positivo"], ans:1, exp:"Que responder dé más fuerza a la provocación y a veces el silencio sea mejor equivale a 'a veces callar ante la provocación es lo más sabio' (B). A aconseja lo contrario; C tacha el silencio de cobardía; D elogia provocar." },
  { id:"v_par_10", domain:"verbal", topic:"parafrasis", dif:3, stem:"Los logros importantes rara vez son fruto del talento solo; casi siempre exigen constancia.", q:"¿Cuál opción conserva el sentido?", opts:["El talento es lo único que importa","La constancia es clave para los grandes logros","Sin talento no se logra nada","El esfuerzo no sirve de nada"], ans:1, exp:"Que los logros exijan constancia más que talento equivale a que la constancia es clave para los grandes logros (B). A y C sobrevaloran el talento; D niega el esfuerzo, lo opuesto al texto." },
  { id:"v_par_11", domain:"verbal", topic:"parafrasis", dif:3,
    ...
    ans:1, exp:"'Roma no se construyó en un día' equivale a que las cosas grandes toman tiempo (B). A dice lo contrario; C y D toman el refrán de forma literal y pierden su sentido." },
  ...
  { id:"v_pro_9", domain:"verbal", topic:"proposiciones", dif:3,
    ...
    ans:1, exp:"De 'todos los que aprobaron entregaron' se deduce que quien no entregó no aprobó (I) y que entregar fue necesario (III): por eso B. La II dice lo contrario." },
  { id:"v_pro_10", domain:"verbal", topic:"proposiciones", dif:2,
    ...
    ans:0, exp:"De 'cuando hay sol, la ropa se seca' se deduce que el sol seca la ropa: la I (A). La II (se seca sin sol) y la III (el sol la moja) no se siguen del texto." },
  ...
  /* -- Verbal: comportamiento -- */
  { id:"v_com_10", domain:"verbal", topic:"comportamiento", dif:2, stem:"Cuando el proyecto falla, en vez de buscar culpables, el líder reúne al equipo y plantea soluciones.", q:"¿Cómo se comporta el líder?", opts:["Culpa a los demás","Actúa de forma constructiva","Abandona el proyecto","Se queda callado"], ans:1, exp:"Buscar soluciones en vez de culpables es actuar de forma constructiva (B). No culpa a los demás (A), no abandona el proyecto (C) ni se queda callado (D): toma la iniciativa." },
  ...
  { id:"v_ord_11", domain:"verbal", topic:"orden_desorden", dif:2, stem:"La bodega solía ser un caos: cajas sin marcar apiladas hasta el techo y productos vencidos mezclados con los nuevos. Hoy todo está clasificado por tipo, con etiquetas y fechas a la vista.", q:"¿Qué cambio experimentó la bodega?", opts:["Del orden al desorden","Del desorden al orden","De grande a pequeña","De llena a vacía"], ans:1, exp:"De cajas sin marcar y productos mezclados (desorden) a todo clasificado y etiquetado (orden): del desorden al orden (B). A es lo contrario; tamaño (C) y si está llena o vacía (D) no son el cambio." },

  /* -- Verbal: orden temporal -- */
  { id:"v_tmp_10", domain:"verbal", topic:"orden_temporal", dif:2, stem:"Se siembra la semilla, se riega cada día, brota la planta y, al final, se cosecha.", q:"¿Qué ocurre justo antes de cosechar?", opts:["Sembrar la semilla","Que brote la planta","Regar la semilla","Comprar semillas"], ans:1, exp:"La secuencia es sembrar, regar, brotar y cosechar. Antes de cosechar, brota la planta (B). Sembrar (A) y regar (C) van antes; comprar semillas (D) no es parte de la secuencia." },
  { id:"v_tmp_11", domain:"verbal", topic:"orden_temporal", dif:2, stem:"Primero se reúnen los materiales, luego se arma la estructura y, por último, se pinta.", q:"¿Qué se hace justo después de reunir los materiales?", opts:["Pintar","Armar la estructura","Reunir más materiales","Limpiar todo"], ans:1, exp:"Después de reunir los materiales se arma la estructura (B). Pintar (A) es el último paso; reunir más (C) y limpiar (D) no están en la secuencia descrita." },

  /* -- Verbal: esencia -- */
  { id:"v_ese_10", domain:"verbal", topic:"esencia", dif:2, stem:"Si lo propio de un mapa es representar un territorio a escala, entonces cada objeto se define por la función que cumple, no por su apariencia.", q:"Por la misma lógica, ¿qué es lo propio de un reloj?", opts:["Representar un territorio","Marcar el paso del tiempo","Medir la temperatura","Indicar el peso"], ans:1, exp:"Lo propio es la función. La del reloj es marcar el tiempo (B). Representar un territorio (A) es del mapa; medir temperatura (C), del termómetro; pesar (D), de la balanza." },
  ...
  /* -- Verbal: perspectiva -- */
  { id:"v_per_11", domain:"verbal", topic:"perspectiva", dif:2, stem:"El mismo precio que a una persona de ingresos ajustados le parece carísimo, a otra de mayores ingresos le resulta accesible.", q:"¿Qué idea expresa el texto?", opts:["El precio es objetivamente alto","Lo caro o lo barato depende de la situación de quien compra","Nadie puede pagar ese precio","El precio debería ser igual para todos"], ans:1, exp:"El mismo precio se percibe distinto según los ingresos de cada quien (B). A lo vuelve absoluto; C exagera; D propone algo que el texto no plantea." },
  { id:"v_per_12", domain:"verbal", topic:"perspectiva", dif:3, stem:"La misma noticia —el gol en el último minuto— estalla en alegría entre los seguidores de un equipo y en tristeza entre los del rival.", q:"¿Qué muestra el texto?", opts:["Las emociones fuertes hacen perder la objetividad","Un mismo hecho provoca emociones opuestas según el bando de cada quien","La rivalidad deportiva siempre termina en conflicto","El resultado de un partido no le importa a nadie"], ans:1, exp:"El mismo gol alegra a unos y entristece a otros según a qué equipo sigan (B). A y C son frases que suenan razonables, pero no son lo que el texto muestra; D contradice las emociones que describe." },

  /* -- Verbal: idea implícita -- */
  { id:"v_imp_15", domain:"verbal", topic:"idea_implicita", dif:1, stem:"Entró a la oficina con el paraguas chorreando, los zapatos empapados y dejando un reguero de gotas en el piso.", q:"¿Qué se puede concluir, aunque el texto no lo diga directamente?", opts:["Que afuera hacía calor","Que afuera estaba lloviendo","Que venía de nadar","Que era de madrugada"], ans:1, exp:"Un paraguas chorreando y zapatos empapados son señales de lluvia: se concluye que afuera llovía (B). El calor (A) no moja; venir de nadar (C) no explica el paraguas; la hora (D) no se deduce." },
  { id:"v_imp_16", domain:"verbal", topic:"idea_implicita", dif:2, stem:"Desde que cambió de entrenador, el equipo no ha vuelto a perder.", q:"¿Cuál es una idea implícita?", opts:["El equipo siempre pierde","El cambio de entrenador mejoró al equipo","Ya no juegan","El entrenador anterior era mejor"], ans:1, exp:"Que dejara de perder justo tras el cambio implica que el nuevo entrenador mejoró al equipo (B). A dice lo contrario; 'ya no juegan' (C) no se deduce; y D contradice la mejora." },
  ...
  /* -- Verbal: idea principal -- */
  { id:"v_pri_13", domain:"verbal", topic:"idea_principal", dif:2, stem:"Reciclar los desechos, usar el transporte público y ahorrar energía son acciones cotidianas que ayudan a cuidar el planeta.", q:"¿Cuál es la idea principal?", opts:["Hay que usar transporte público","Pequeñas acciones diarias ayudan a cuidar el planeta","Reciclar resulta difícil","La energía es cada vez más cara"], ans:1, exp:"A es una de las acciones (detalle); C y D agregan juicios que el texto no hace. B resume el conjunto: acciones cotidianas que cuidan el planeta." },
  { id:"v_pri_14", domain:"verbal", topic:"idea_principal", dif:2, stem:"El sueño, la alimentación y la manera de manejar el estrés influyen, cada uno a su modo, en la salud mental de una persona.", q:"¿Cuál es la idea principal?", opts:["El estrés daña la salud mental","Varios factores cotidianos influyen en la salud mental","Hay que dormir más horas","La alimentación debe cuidarse"], ans:1, exp:"A, C y D toman un solo factor cada uno (detalles). B recoge la idea general: varios factores influyen en la salud mental." },
  { id:"v_pri_15", domain:"verbal", topic:"idea_principal", dif:2, stem:"La marimba acompaña las fiestas populares, transmite tradiciones de generación en generación y se ha vuelto un símbolo de la identidad centroamericana.", q:"¿Cuál es el tema central?", opts:["La marimba suena en las fiestas","El valor cultural y simbólico de la marimba","La marimba es un instrumento de madera","Las tradiciones se están perdiendo"], ans:1, exp:"A es un detalle; C es un dato físico; D ni aparece. B reúne lo festivo, lo tradicional y lo identitario: ese es el tema central." },

  /* -- Verbal: paráfrasis -- */
  { id:"v_par_12", domain:"verbal", topic:"parafrasis", dif:3, stem:"Mantener la calma en los momentos difíciles suele abrir mejores soluciones que dejarse llevar por el enojo.", q:"¿Cuál opción dice lo mismo?", opts:["El enojo resuelve los problemas","La calma ayuda a encontrar mejores soluciones","Los momentos difíciles no tienen salida","Conviene no pensar en los problemas"], ans:1, exp:"Que la calma abra mejores soluciones que el enojo equivale a que la calma ayuda a encontrar mejores soluciones (B). A ensalza el enojo; C niega toda salida; D aconseja no pensar, lo opuesto al texto." },
  { id:"v_par_13", domain:"verbal", topic:"parafrasis", dif:2, stem:"Posponer una y otra vez las tareas no las elimina: solo las acumula y las vuelve más pesadas.", q:"¿Cuál opción reproduce la idea?", opts:["Posponer hace desaparecer las tareas","Aplazar las tareas solo las acumula","Las tareas se resuelven solas","Mañana es mejor momento que hoy"], ans:1, exp:"Que posponer no elimine las tareas sino que las acumule y agrave equivale a que aplazarlas solo las acumula (B). A dice lo contrario; C y D minimizan el problema, contra el texto." },
  { id:"v_par_14", domain:"verbal", topic:"parafrasis", dif:3, stem:"Camarón que se duerme, se lo lleva la corriente.", q:"¿Cuál opción dice lo mismo con otras palabras?", opts:["Dormir es muy saludable","Quien se descuida pierde oportunidades","Los camarones nadan rápido","Hay que dormir más"], ans:1, exp:"'Camarón que se duerme se lo lleva la corriente' equivale a que quien se descuida pierde oportunidades (B). A, C y D toman el refrán al pie de la letra y pierden su sentido figurado." },

  /* -- Verbal: proposiciones -- */
  { id:"v_pro_11", domain:"verbal", topic:"proposiciones", dif:3, stem:"Toda sustancia ácida cambia el color del papel tornasol. Analice las proposiciones:\nI. Si una sustancia no cambia el color del papel, no es ácida.\nII. Ninguna sustancia ácida afecta el papel tornasol.\nIII. El vinagre, que es ácido, cambia el color del papel.", q:"¿Cuáles proposiciones se deducen del texto?", opts:["Solo la II","La I y la III","Solo la I","Las tres"], ans:1, exp:"De 'toda sustancia ácida cambia el papel' se deducen la I (si no lo cambia, no es ácida) y la III (el vinagre ácido lo cambia): por eso B. La II niega el efecto, contra el texto." },
  { id:"v_pro_12", domain:"verbal", topic:"proposiciones", dif:2, stem:"Si un animal es mamífero, respira con pulmones. Analice las proposiciones:\nI. La ballena, que es mamífero, respira con pulmones.\nII. Los mamíferos no tienen pulmones.\nIII. Ningún mamífero respira.", q:"¿Cuál proposición se deduce del texto?", opts:["Solo la I","Solo la II","La II y la III","Las tres"], ans:0, exp:"De 'si es mamífero, respira con pulmones' se deduce que la ballena, que es mamífero, respira con pulmones: la I (A). La II y la III niegan los pulmones o la respiración, contra el texto." },
  ...
  { id:"v_fin_12", domain:"verbal", topic:"finalidad", dif:3, stem:"Una ley obliga a etiquetar el contenido calórico de los alimentos no para prohibir su consumo, sino para que cada persona decida con información.", q:"¿Cuál es la finalidad de la ley, según el texto?", opts:["Prohibir los alimentos calóricos","Que las personas decidan con información","Subir el precio de los alimentos","Cerrar los restaurantes"], ans:1, exp:"El texto contrapone: no para prohibir, sino para que cada persona decida con información (B). Por eso no es prohibir (A); subir precios (C) y cerrar restaurantes (D) no se plantean." },
  { id:"v_com_12", domain:"verbal", topic:"comportamiento", dif:3, stem:"Aunque el mundo insista en apurarme, yo elijo detenerme a mirar el árbol, la nube, el instante que nadie más nota.", q:"¿Qué actitud refleja el autor?", opts:["Apresurada","Contemplativa","Indiferente","Agresiva"], ans:1, exp:"Detenerse a mirar el árbol, la nube, el instante que nadie nota, es una actitud contemplativa (B). Es lo opuesto a apresurada (A); no es indiferente (C: sí le importa mirar) ni agresiva (D)." },
  ...
  { id:"v_con_14", domain:"verbal", topic:"conceptualizacion", dif:3, stem:"Sabía que decir la verdad le costaría el puesto, pero aun así la dijo.", q:"¿Qué palabra describe mejor su actitud?", opts:["Integridad","Conveniencia","Cobardía","Indiferencia"], ans:0, exp:"Decir la verdad aun a costa de perder el puesto es integridad (A). Lo contrario sería buscar la conveniencia (B) o callar por cobardía (C); no es indiferencia (D): justo le importa la verdad." },
  { id:"v_ese_12", domain:"verbal", topic:"esencia", dif:3, stem:"Así como el termómetro no cambia la fiebre sino que la mide, el examen no crea el conocimiento: solo lo evidencia.", q:"¿Qué idea sostiene el texto?", opts:["El examen crea el conocimiento","El examen solo evidencia el conocimiento, no lo genera","El termómetro cura la fiebre","Los exámenes son inútiles"], ans:1, exp:"La analogía muestra que el examen solo evidencia el conocimiento, no lo crea, igual que el termómetro mide la fiebre sin curarla (B). Por eso A es falso; C confunde medir con curar; y D exagera al llamarlos inútiles." },
  { id:"v_per_13", domain:"verbal", topic:"perspectiva", dif:3, stem:"Para el historiador, la ruina es un documento; para el turista, una postal; para el vecino, un estorbo.", q:"¿Qué muestra el texto?", opts:["La ruina debe demolerse","El valor de algo depende de la mirada de cada quien","Los turistas no entienden la historia","Las ruinas no sirven"], ans:1, exp:"Para el historiador es documento, para el turista postal y para el vecino estorbo: el valor depende de la mirada de cada quien (B). El texto no pide demolerla (A), ni descalifica a los turistas (C) ni niega el valor de la ruina (D)." },
  { id:"v_imp_18", domain:"verbal", topic:"idea_implicita", dif:3, stem:"El político prometió exactamente lo mismo que hace cuatro años, y la plaza, esta vez, quedó medio vacía.", q:"¿Cuál es una idea implícita?", opts:["La plaza es muy pequeña","La gente perdió interés o confianza en él","Hacía mal clima","El político renunció"], ans:1, exp:"Prometer lo mismo y que la plaza quede medio vacía implica que la gente perdió interés o confianza (B). El tamaño de la plaza (A), el clima (C) o una renuncia (D) no se deducen." },
  { id:"v_imp_19", domain:"verbal", topic:"idea_implicita", dif:3, stem:"Ningún alumno entregó la tarea; el profesor sonrió: no tendría nada que revisar esa noche.", q:"¿Qué se deduce del texto?", opts:["El profesor estaba furioso","Al no haber entregas, no tendrá trabajo que revisar","Todos los alumnos aprobaron","El profesor renunció"], ans:1, exp:"Que sonría porque 'no tendrá nada que revisar' implica que, sin entregas, no tendrá trabajo esa noche (B). La furia (A) contradice la sonrisa; aprobar todos (C) y renunciar (D) no se deducen." },
  { id:"v_pri_16", domain:"verbal", topic:"idea_principal", dif:3, stem:"El bosque no es un conjunto de árboles aislados: bajo la tierra, sus raíces se conectan con hongos que intercambian agua y nutrientes, formando una red que sostiene a todo el ecosistema.", q:"¿Cuál es la idea principal del texto?", opts:["Los árboles compiten entre sí","El bosque funciona como una red interconectada","Los hongos son dañinos para los árboles","Las raíces no cumplen ninguna función"], ans:1, exp:"Todo el texto describe cómo raíces y hongos se conectan y sostienen el ecosistema: el bosque funciona como una red interconectada (B). A, C y D contradicen esa idea de cooperación." },
  { id:"v_par_15", domain:"verbal", topic:"parafrasis", dif:3, stem:"La libertad sin responsabilidad no es libertad, sino mero capricho.", q:"¿Cuál opción expresa la misma idea?", opts:["La libertad no tiene ningún límite","Ser verdaderamente libre implica ser responsable","La responsabilidad impide la libertad","El capricho es la forma más alta de libertad"], ans:1, exp:"Que la libertad sin responsabilidad sea capricho equivale a que ser de verdad libre implica ser responsable (B). A niega todo límite; C opone libertad y responsabilidad; D ensalza el capricho, lo contrario del texto." },
  { id:"v_pro_13", domain:"verbal", topic:"proposiciones", dif:3, stem:"El desarrollo sostenible busca satisfacer las necesidades del presente sin comprometer las de las futuras generaciones. Analice las proposiciones:\nI. Propone no agotar los recursos que necesitarán quienes vengan.\nII. Exige frenar todo progreso.\nIII. Toma en cuenta tanto el presente como el futuro.\nIV. Ignora las necesidades actuales.", q:"¿Cuáles proposiciones son ciertas según el texto?", opts:["I y III","Solo la II","II y IV","Todas"], ans:0, exp:"El texto cuida el presente sin comprometer el futuro: se deducen la I (no agotar recursos futuros) y la III (atiende presente y futuro): por eso A. La II (frenar todo progreso) y la IV (ignorar lo actual) lo contradicen." },
  { id:"v_pro_14", domain:"verbal", topic:"proposiciones", dif:3, stem:"La lectura crítica no consiste en aceptar lo que se lee, sino en cuestionarlo con argumentos. Analice las proposiciones:\nI. Leer de forma crítica es dudar con fundamento.\nII. Leer de forma crítica es creer todo lo escrito.\nIII. Implica evaluar los argumentos.\nIV. Consiste en rechazar todo lo que se lee.", q:"¿Cuáles proposiciones se deducen del texto?", opts:["I y III","I y II","III y IV","Solo la IV"], ans:0, exp:"Leer de forma crítica es cuestionar con argumentos: se deducen la I (dudar con fundamento) y la III (evaluar argumentos): por eso A. La II (creer todo) y la IV (rechazar todo) son los extremos que el texto descarta." },
  ...
  /* ===================== LOTE 5 — lecturas densas + figuras (nivel examen) ===================== */
  { id:"v_pri_17", domain:"verbal", topic:"idea_principal", dif:3, stem:"La memoria no funciona como una grabadora que reproduce fielmente lo ocurrido. Cada vez que recordamos, reconstruimos el episodio con piezas del presente: nuestro estado de ánimo, lo que aprendimos después, incluso lo que otros nos contaron. Por eso dos personas que vivieron el mismo hecho pueden recordarlo de maneras distintas y ambas estar convencidas de su versión.", q:"¿Cuál es la idea principal del texto?", opts:["La memoria reproduce los hechos con total fidelidad","Recordar es reconstruir, no reproducir exactamente lo vivido","Solo una versión de un recuerdo puede ser verdadera","La memoria mejora con el paso del tiempo"], ans:1, exp:"El texto insiste en que al recordar reconstruimos con elementos del presente; por eso no es una copia fiel, sino una reconstrucción." },
  { id:"v_imp_20", domain:"verbal", topic:"idea_implicita", dif:3, stem:"Durante años, el puente de madera soportó el paso de carretas y caminantes. Cuando llegaron los primeros camiones, las autoridades siguieron usándolo sin reforzarlo, confiadas en que siempre había aguantado. Una mañana de lluvia, cedió.", q:"¿Qué se puede deducir del texto?", opts:["El puente era indestructible","Confiar en el pasado sin considerar las nuevas cargas resultó un error","Los camiones eran demasiado livianos","La lluvia fue la única causa del colapso"], ans:1, exp:"Seguir usando el puente sin reforzarlo porque 'siempre aguantó' y que luego ceda implica que confiar en el pasado sin ver las nuevas cargas fue un error (B). A lo niega; los camiones eran más pesados, no livianos (C); y la lluvia fue el detonante, no la única causa (D)." },
  { id:"v_pro_15", domain:"verbal", topic:"proposiciones", dif:3, stem:"El método científico no garantiza verdades absolutas: ofrece las mejores explicaciones disponibles, siempre abiertas a revisión si aparece nueva evidencia. Su fuerza no está en no equivocarse nunca, sino en corregirse. Analice las proposiciones:\nI. La ciencia ofrece explicaciones provisionales, revisables ante nueva evidencia.\nII. La ciencia entrega verdades definitivas e incuestionables.\nIII. La capacidad de corregirse es una de sus fortalezas.\nIV. Equivocarse invalida por completo a la ciencia.", q:"¿Cuáles proposiciones concuerdan con el texto?", opts:["I y III","II y IV","Solo la I","Todas"], ans:0, exp:"La ciencia da explicaciones revisables y se corrige: se deducen la I y la III: por eso A. La II (verdades definitivas) y la IV (equivocarse la invalida) contradicen el texto." },
  { id:"v_per_14", domain:"verbal", topic:"perspectiva", dif:3, stem:"El mismo bosque que para el leñador es una reserva de madera, para el biólogo es un ecosistema que estudiar, para el excursionista un refugio de paz y para la empresa minera, un obstáculo sobre un yacimiento.", q:"¿Qué idea central transmite el texto?", opts:["El bosque debería talarse","Un mismo lugar adquiere significados distintos según los intereses de cada quien","Solo el biólogo comprende el bosque","Los bosques no tienen valor económico"], ans:1, exp:"El bosque vale distinto para el leñador, el biólogo, el excursionista y la minera: su significado depende de los intereses de cada quien (B). No propone talarlo (A), no dice que solo el biólogo lo entienda (C) ni que carezca de valor económico (D)." },
  { id:"v_cau_17", domain:"verbal", topic:"causa_consecuencia", dif:3, stem:"Cuando una especie depredadora desaparece de un ecosistema, la población de sus presas suele dispararse. Ese exceso agota la vegetación de la que se alimentan y, con el tiempo, el hambre reduce drásticamente a las propias presas. Así, la ausencia del depredador termina perjudicando a quienes parecían beneficiarse.", q:"Según el texto, ¿cuál es la consecuencia final de que desaparezca el depredador?", opts:["Las presas prosperan para siempre","Las presas terminan reduciéndose por falta de alimento","La vegetación crece sin límite","El ecosistema no sufre cambios"], ans:1, exp:"Sin depredador, las presas crecen, agotan su alimento y luego disminuyen por hambre (B). Prosperar para siempre (A) y el crecimiento sin límite (C) ignoran ese tope; y sí hay cambios, así que D es falso." },
  { id:"v_par_16", domain:"verbal", topic:"parafrasis", dif:3, stem:"Quien solo conoce su propia postura, en realidad la conoce a medias: sin contrastarla con otras, no puede ver sus puntos débiles.", q:"¿Cuál opción expresa mejor la idea del texto?", opts:["Conviene ignorar las posturas ajenas","Comprender de verdad una idea exige confrontarla con otras","Tener una sola postura es lo ideal","Las posturas ajenas no aportan nada"], ans:1, exp:"Que conocer solo la propia postura sea conocerla a medias equivale a que entender de verdad una idea exige confrontarla con otras (B). A, C y D defienden quedarse con una sola postura, lo opuesto al texto." },
  { id:"v_con_15", domain:"verbal", topic:"conceptualizacion", dif:3, stem:"No reaccionó cuando lo provocaron, no respondió a la burla con otra burla y, aun teniendo motivos de sobra para enojarse, eligió mantener la calma y seguir con su trabajo.", q:"¿Qué palabra describe mejor su actitud?", opts:["Templanza","Cobardía","Indiferencia","Soberbia"], ans:0, exp:"Dominarse y no caer en la provocación, pudiendo enojarse, es templanza o autocontrol (A). No es cobardía (B: elige no reaccionar), ni indiferencia (C: sí le afecta) ni soberbia (D)." },
  { id:"v_pri_18", domain:"verbal", topic:"idea_principal", dif:3, stem:"Leer ficción no es una fuga inútil de la realidad. Al ponernos en la piel de personajes muy distintos de nosotros, la novela entrena nuestra capacidad de imaginar lo que siente el otro; diversos estudios asocian la lectura literaria con una mayor empatía.", q:"¿Cuál es la idea principal del texto?", opts:["La ficción es una pérdida de tiempo","Leer ficción ayuda a desarrollar la empatía","Solo deberían leerse libros de no ficción","Los personajes deben parecerse al lector"], ans:1, exp:"El texto defiende que la ficción, al hacernos sentir lo que sienten otros, desarrolla la empatía (B). A y C la desprecian, y D agrega una condición que el texto no plantea." },
  { id:"v_imp_21", domain:"verbal", topic:"idea_implicita", dif:3, stem:"En la entrevista, el candidato respondió cada pregunta con frases largas que sonaban muy bien pero no decían nada concreto; al terminar, nadie en la sala habría podido explicar qué proponía realmente.", q:"¿Qué se puede deducir del texto?", opts:["El candidato tenía propuestas muy claras","El candidato evitó comprometerse con ideas concretas","La entrevista fue muy corta","El público entendió perfectamente su plan"], ans:1, exp:"Frases que suenan bien pero no dicen nada concreto implican que el candidato evitó comprometerse con ideas concretas (B). A dice lo contrario; 'entrevista corta' (C) y 'público entendió' (D) contradicen el texto." },
  { id:"v_pro_16", domain:"verbal", topic:"proposiciones", dif:3, stem:"Toda decisión implica renunciar a las demás opciones: elegir un camino es, a la vez, dejar de recorrer los otros. Por eso, decidir bien no es evitar toda pérdida, sino aceptar la pérdida que más vale la pena. Analice las proposiciones:\nI. Elegir una opción supone renunciar a otras.\nII. Es posible decidir sin renunciar a nada.\nIII. Decidir bien implica asumir la mejor pérdida posible.\nIV. Las buenas decisiones no tienen ningún costo.", q:"¿Cuáles proposiciones se deducen del texto?", opts:["I y III","II y IV","Solo la III","Todas"], ans:0, exp:"Toda decisión implica renunciar a otras opciones (I) y decidir bien es asumir la mejor pérdida (III): por eso A. La II (decidir sin renunciar) y la IV (sin ningún costo) niegan la idea central." },
  { id:"m_geo_14", domain:"math", topic:"geometria", dif:3, fig:'<svg viewBox="0 0 180 165" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="35" y="15" width="120" height="120" fill="rgba(46,230,166,.20)" stroke="var(--brand)" stroke-width="2"/><rect x="71" y="51" width="48" height="48" fill="var(--ink)" stroke="var(--brand)" stroke-width="2"/><text x="74" y="153" fill="currentColor" font-size="13">6 cm</text><text x="82" y="79" fill="currentColor" font-size="11">4 cm</text></svg>', stem:"La figura es un cuadrado de 6 cm de lado con un cuadrado de 4 cm de lado recortado en su interior.", q:"¿Cuál es el área de la región sombreada?", opts:["20 cm²","16 cm²","36 cm²","52 cm²"], ans:0, exp:"Área del cuadrado grande menos la del recortado: 6² − 4² = 36 − 16 = 20 cm²." },
  { id:"m_cnt_14", domain:"math", topic:"conteo", dif:3, fig:'<svg viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="20" width="120" height="120" stroke="var(--math)" stroke-width="2"/><line x1="80" y1="20" x2="80" y2="140" stroke="var(--math)" stroke-width="2"/><line x1="20" y1="80" x2="140" y2="80" stroke="var(--math)" stroke-width="2"/></svg>', stem:"Observe la cuadrícula de 2 × 2 de la figura.", q:"¿Cuántos cuadrados en total se pueden contar?", opts:["4","5","6","8"], ans:1, exp:"Hay 4 cuadrados pequeños más 1 grande que los contiene a todos: 4 + 1 = 5." },
  { id:"m_cnt_15", domain:"math", topic:"conteo", dif:3, fig:'<svg viewBox="0 0 170 170" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="15" width="135" height="135" stroke="var(--math)" stroke-width="2"/><line x1="60" y1="15" x2="60" y2="150" stroke="var(--math)" stroke-width="2"/><line x1="105" y1="15" x2="105" y2="150" stroke="var(--math)" stroke-width="2"/><line x1="15" y1="60" x2="150" y2="60" stroke="var(--math)" stroke-width="2"/><line x1="15" y1="105" x2="150" y2="105" stroke="var(--math)" stroke-width="2"/></svg>', stem:"Observe la cuadrícula de 3 × 3 de la figura.", q:"¿Cuántos cuadrados en total se pueden contar (de todos los tamaños)?", opts:["9","13","14","10"], ans:2, exp:"9 cuadrados de 1×1, 4 de 2×2 y 1 de 3×3: 9 + 4 + 1 = 14." },
  ...
  { id:"v_lec_1", domain:"verbal", topic:"idea_principal", dif:3, stem:"Durante mucho tiempo se creyó que el talento era algo con lo que se nacía: o se tenía o no. Investigaciones recientes matizan esa idea: aunque las aptitudes iniciales existen, lo que distingue a quienes llegan lejos es la práctica deliberada —repetir con atención, corregir los errores y buscar retos un poco por encima del nivel actual—. El talento, más que un punto de partida fijo, parece el resultado de años de trabajo bien orientado.", q:"¿Cuál es la idea principal del texto?", opts:["El talento es algo con lo que simplemente se nace","Más que innato, el talento se construye con práctica deliberada","La práctica no influye en los resultados","Solo quienes nacen con aptitudes pueden llegar lejos"], ans:1, exp:"El texto matiza la creencia del talento innato y concluye que se construye con práctica bien orientada (B). A y D repiten justo la idea que el texto corrige; C contradice todo el argumento." },
  { id:"v_lec_2", domain:"verbal", topic:"idea_implicita", dif:3, stem:"El pueblo entero esperaba la llegada del nuevo médico. Pasaron las semanas y la casa que le habían preparado seguía con las ventanas cerradas; la farmacia, que había encargado medicinas de más, empezó a devolverlas; y en la parada, el cartel de bienvenida se fue despintando con la lluvia.", q:"¿Qué se puede deducir del texto, aunque no se diga directamente?", opts:["El médico llegó y se instaló sin problemas","El médico, finalmente, no llegó al pueblo","El pueblo no necesitaba un médico","La farmacia cerró para siempre"], ans:1, exp:"Ventanas cerradas, medicinas devueltas y el cartel despintándose son señales de que el médico nunca llegó (B). A lo contradice; C y D inventan cosas que el texto no dice." },
  { id:"v_lec_3", domain:"verbal", topic:"proposiciones", dif:3, stem:"Todos los estudiantes que entrenaron con el simulador aprobaron el examen de manejo. Carlos aprobó el examen de manejo.", q:"¿Qué se puede concluir con certeza?", opts:["Carlos entrenó con el simulador","Carlos no entrenó con el simulador","No se puede saber si Carlos entrenó con el simulador","El simulador no sirve para aprobar"], ans:2, exp:"Que TODOS los del simulador aprobaran no significa que SOLO ellos aprobaran: Carlos pudo aprobar por otra vía. Por eso no se puede saber si entrenó o no (C). A y B afirman de más; D no se sigue del texto." },
  { id:"v_lec_4", domain:"verbal", topic:"perspectiva", dif:3, stem:"Para el ingeniero, el viejo puente de hierro es una estructura obsoleta que conviene demoler; para el historiador, un testimonio de la industria de hace un siglo; para los vecinos que cruzan por él cada día, simplemente el camino más corto a la escuela.", q:"¿Qué idea central transmite el texto?", opts:["El puente debe conservarse a toda costa","Un mismo objeto tiene un valor distinto según los intereses de cada quien","El ingeniero está equivocado","Los puentes de hierro ya no le sirven a nadie"], ans:1, exp:"El puente significa cosas distintas según quién lo mire (B). El texto no toma partido por conservarlo (A) ni dice que el ingeniero se equivoque (C); y D contradice que para los vecinos sí sirve." },
  { id:"v_lec_5", domain:"verbal", topic:"simple_complejo", dif:3, stem:"Encender la luz de una habitación parece inmediato: basta mover un interruptor. Detrás, sin embargo, hay represas o plantas que generan la electricidad, miles de kilómetros de cables, transformadores que ajustan el voltaje y un sistema que equilibra la oferta y la demanda en tiempo real para que esa luz, simplemente, encienda.", q:"¿Qué contraste plantea el texto?", opts:["Que la electricidad es peligrosa","Que detrás de un gesto simple puede haber un sistema muy complejo","Que encender la luz cuesta mucho dinero","Que las represas contaminan el ambiente"], ans:1, exp:"El texto opone un acto simple (mover un interruptor) con todo el sistema complejo que lo hace posible (B). No habla de peligro (A), de costo (C) ni de contaminación (D)." },
  { id:"v_lec_6", domain:"verbal", topic:"parafrasis", dif:3, stem:"Quien promete demasiado y a todos termina por no cumplirle a nadie: las palabras que se reparten sin medida pierden el peso que las hacía valiosas.", q:"¿Cuál opción expresa mejor la idea del texto?", opts:["Hay que prometer mucho para caer bien","Prometer sin medida hace que las promesas pierdan su valor","Las promesas siempre se terminan cumpliendo","Nadie debería hacer ninguna promesa"], ans:1, exp:"Repartir promesas sin medida las vacía de valor (B). A aconseja lo contrario; C es falso según el texto; D exagera, pues el texto no prohíbe prometer, critica el exceso." },
  { id:"v_lec_7", domain:"verbal", topic:"causa_consecuencia", dif:3, stem:"En los meses en que más helados se venden también es cuando más gente se ahoga en las playas. Sin embargo, nadie diría que comer helado provoque ahogamientos: ambas cosas suben porque coincide el calor del verano, que llena a la vez las heladerías y las playas.", q:"¿Qué idea sostiene el texto?", opts:["Comer helado causa los ahogamientos","Dos cosas que aumentan juntas no siempre son causa una de la otra","Habría que prohibir los helados en verano","En verano nadie va a la playa"], ans:1, exp:"El ejemplo muestra que coincidir (subir juntas) no es lo mismo que causar (B): el verdadero factor común es el calor. A confunde justo eso; C y D no se siguen del texto." },
  { id:"v_lec_8", domain:"verbal", topic:"idea_implicita", dif:3, stem:"En la reunión, todos felicitaron el nuevo plan. Pero cuando el jefe preguntó quién quería encargarse de ejecutarlo, los aplausos se apagaron, las miradas bajaron hacia los cuadernos y, de pronto, varios recordaron compromisos urgentes.", q:"¿Qué se puede deducir del texto?", opts:["Todos querían liderar el plan","El entusiasmo por el plan no se tradujo en un compromiso real","El plan fue rechazado por completo","El jefe canceló la reunión"], ans:1, exp:"Aplaudir y, al pedir responsables, esquivar la tarea muestra que el entusiasmo no se volvió compromiso (B). A lo contradice; C exagera (sí lo felicitaron) y D no ocurre." },
  { id:"m_cnt_17", domain:"math", topic:"conteo", dif:3, fig:'<svg viewBox="0 0 170 170" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="25" y="25" width="120" height="120" stroke="var(--math)" stroke-width="2"/><line x1="55" y1="25" x2="55" y2="145" stroke="var(--math)" stroke-width="1.5"/><line x1="85" y1="25" x2="85" y2="145" stroke="var(--math)" stroke-width="1.5"/><line x1="115" y1="25" x2="115" y2="145" stroke="var(--math)" stroke-width="1.5"/><line x1="25" y1="55" x2="145" y2="55" stroke="var(--math)" stroke-width="1.5"/><line x1="25" y1="85" x2="145" y2="85" stroke="var(--math)" stroke-width="1.5"/><line x1="25" y1="115" x2="145" y2="115" stroke="var(--math)" stroke-width="1.5"/></svg>', stem:"Observe la cuadrícula de 4 × 4 de la figura.", q:"¿Cuántos cuadrados en total se pueden contar (de todos los tamaños)?", opts:["16","26","30","20"], ans:2, exp:"16 cuadrados de 1×1, 9 de 2×2, 4 de 3×3 y 1 de 4×4: 16 + 9 + 4 + 1 = 30." },
  { id:"m_cnt_18", domain:"math", topic:"conteo", dif:3, fig:'<svg viewBox="0 0 180 150" fill="none" xmlns="http://www.w3.org/2000/svg"><polygon points="90,15 20,135 160,135" fill="rgba(77,163,255,.10)" stroke="var(--math)" stroke-width="2"/><line x1="90" y1="15" x2="67" y2="135" stroke="var(--math)" stroke-width="2"/><line x1="90" y1="15" x2="113" y2="135" stroke="var(--math)" stroke-width="2"/></svg>', stem:"En la figura, un triángulo grande está dividido por dos líneas que bajan desde el vértice superior hasta la base.", q:"¿Cuántos triángulos hay en total?", opts:["4","5","6","7"], ans:2, exp:"3 triángulos pequeños, 2 que se forman al juntar dos seguidos y 1 grande que junta los tres: 3 + 2 + 1 = 6." },
  { id:"m_cnt_19", domain:"math", topic:"conteo", dif:2, fig:'<svg viewBox="0 0 210 90" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="30" width="170" height="40" stroke="var(--math)" stroke-width="2"/><line x1="76" y1="30" x2="76" y2="70" stroke="var(--math)" stroke-width="2"/><line x1="133" y1="30" x2="133" y2="70" stroke="var(--math)" stroke-width="2"/></svg>', stem:"La figura es una tira dividida en 3 partes iguales.", q:"¿Cuántos rectángulos en total se pueden contar?", opts:["3","4","5","6"], ans:3, exp:"3 rectángulos de una sola parte, 2 de dos partes seguidas y 1 de las tres partes: 3 + 2 + 1 = 6." },
  { id:"m_geo_18", domain:"math", topic:"geometria", dif:3, fig:'<svg viewBox="0 0 200 175" fill="none" xmlns="http://www.w3.org/2000/svg"><polygon points="25,35 145,35 145,80 175,80 175,145 25,145" fill="rgba(46,230,166,.16)" stroke="var(--brand)" stroke-width="2"/><text x="80" y="163" fill="currentColor" font-size="12">10 cm</text><text x="4" y="95" fill="currentColor" font-size="12">8 cm</text></svg>', stem:"La figura en forma de L se formó quitándole a un rectángulo de 10 cm por 8 cm una esquina rectangular de 4 cm por 3 cm.", q:"¿Cuál es el área de la figura?", opts:["68 cm²","80 cm²","12 cm²","92 cm²"], ans:0, exp:"Es el área del rectángulo completo menos la esquina que se quitó: 10 × 8 − 4 × 3 = 80 − 12 = 68 cm²." },
  { id:"m_geo_20", domain:"math", topic:"geometria", dif:2, fig:'<svg viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="135" x2="40" y2="30" stroke="var(--math)" stroke-width="2"/><line x1="40" y1="135" x2="155" y2="135" stroke="var(--math)" stroke-width="2"/><line x1="40" y1="135" x2="135" y2="55" stroke="var(--math)" stroke-width="2"/><text x="46" y="80" fill="currentColor" font-size="13">35°</text><text x="92" y="128" fill="currentColor" font-size="14">?</text></svg>', stem:"En la figura, una línea divide un ángulo recto (90°) en dos partes; una de ellas mide 35°.", q:"¿Cuánto mide la otra parte?", opts:["55°","65°","45°","35°"], ans:0, exp:"Las dos partes juntas forman el ángulo recto, que mide 90°. Entonces la otra mide 90 − 35 = 55°." }
];
