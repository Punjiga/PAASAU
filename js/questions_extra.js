...
window.PAA_QUESTIONS_EXTRA = [
  ...
  { id:"v_sim_8", domain:"verbal", topic:"simple_complejo", dif:2,
    ...
    ans:1, exp:"El pastel de bodas reúne recetas, tiempos y decoración: más complejo que un sándwich de pocos pasos (B). No es más simple (A); precio (C) y rapidez (D) no son el punto." },
  ...
  { id:"v_per_12", domain:"verbal", topic:"perspectiva", dif:2, stem:"La misma noticia —el gol en el último minuto— estalla en alegría entre los seguidores de un equipo y en tristeza entre los del rival.", q:"¿Qué muestra el texto?", opts:["La noticia es falsa para unos","Un mismo hecho se vive distinto según el bando de cada quien","El deporte no genera emociones","Todos terminan sintiendo lo mismo"], ans:1, exp:"El mismo hecho provoca emociones opuestas según a qué equipo se pertenece (B). A inventa una falsedad; C y D contradicen las emociones que el texto describe." },
